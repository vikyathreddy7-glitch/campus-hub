  ...
  return (
    <div className="min-h-screen flex flex-col pb-20">
      ...
      <nav className="fixed bottom-0 left-0 right-0 glass px-6 py-4 flex justify-around items-center z-50 rounded-t-[2rem] border-t border-indigo-50/50">
        ...
        <NavItem to="/lost-found" icon="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z" label="Lost" active={location.pathname === '/lost-found'} />
