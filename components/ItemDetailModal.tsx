        ...
        {checkoutMode ? (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
             <header className="mb-8">
               <h2 className="text-2xl font-black text-gray-900 tracking-tight">Checkout Details</h2>
               <p className="text-sm font-bold text-gray-500">Provide final information for the order record.</p>
             </header>
             ...
             <form onSubmit={handleFinalCheckout} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 block">Date of Event</label>
                    <input 
                      required
                      type="date"
                      className="w-full bg-gray-50 border border-gray-100 rounded-2xl py-4 px-5 text-sm font-bold text-black focus:outline-none shadow-sm"
                ...
                {!isOwner && (
                  <>
                    ...
                    >
                      ...
                      {isMarketplace ? 'Buy Now' : 'Claim Item'}
                    </button>
                    <button 
                      onClick={onMessage}
