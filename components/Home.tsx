            ...
            >
              ...
              <div className="absolute bottom-10 left-8 right-8 z-20">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xl filter drop-shadow-lg">{slide.icon}</span>
                </div>
                <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter leading-tight drop-shadow-sm">
                  {slide.title}
                </h2>
